        ...
        return (
            <section>
                ...
                <section className="box-home">
                    ...
                    <p className="text"> En cada curso, aprenderás las skills más demandadas de la mano de apasionados maestros y
                        un plan de estudios práctico y actualizado. Si apenas estas iniciando o ya eres experto en programación,
                        no te preocupes, encontrarás cursos de nivel básico, intermedio y avanzadado, así que seguramente encontrarás el ideal para ti.
                    </p>
                    <div className="info_box">
                        <div className="dates_box">
                            <div>
                                <h3>+ 5</h3>
                                <p>Más de 5 años ofreciendo educación y mentoría de forma presencial y en línea. </p>
                            </div>
                            <div>
                                <h3>+ 300</h3>
                                <p>Alumnos graduados de nuestros cursos presenciales y en línea. </p>
                            </div>

                            <div>
                                <h3>+ 15</h3>
                                <p>Herramientas y/o frameworks que podrás aprender en nuestros cursos de 2020.</p>
                            </div>
                            <div>
                                <h3>+ 10</h3>
                                <p>Maestros y mentores que te ayudarán a resolver dudas a lo largo de cada curso. </p>
                            </div>
                ...
                <section className="comment">
                    ...
                    <p className="text"> Conoce la experiencia de algunos de nuestros estudiantes. Cada uno de ellos decidio aprender a programar
                        o especificializarse en una herramienta, y agregar este skill a su desarrollo profesional a pesar de tener un background completamente diferente.
                    </p>
                    <br/>
                    <div className="comment_box">
                        <div className="student">
                            <div style={{backgroundImage:`url("${student1}")`}}>

                            </div>
                            <h4 className="names">Carlos Mendoza</h4>
                            <p>Tomar un FixterCamp está lejos de ser un simple curso, es un acercamiento a mundo real de la tecnología y las grandes ideas, aprendí de forma práctica y dinámica temas complejos...</p>
                        </div>
                        <div className="student">
                            <div style={{backgroundImage:`url("${student2}")`}}>

                            </div>
                            <h4 className="names">Jorge García</h4>
                            <p>Estudié la universidad y puedo decir que el ritmo de aprendizaje no se compara con el que Fixter. Los profesores hacen algo más que enseñar y es que todos tienen lo que pocos programadores, calidad para compartir sus conocimientos.</p>
                        </div>
                        <div className="student">
                            <div style={{backgroundImage:`url("${student3}")`}}>

                            </div>
                            <h4 className="names">Oscar Andrei Godoy</h4>
                            <p>En Fixter desmenuzan los temas de la forma más simple para que comprendas a la perfección cada uno de los temas. Creo que cualquier persona puede aprender a programar y, qué mejor que sea de la mano de alguien profesional.</p>
                        </div>
                ...
                <section className="extra" >
                    ...
                    <p className="text">La programación es una de las habilidades con mayor demanda en los últimos años, así que ya sea para comunicarte mejor con tu equipo de desarrollo, cambiar drásticamente tu carrera profesional, completar tu educación o simplemente por curiosidad, no pierdas más tiempo y ¡Empieza ya!</p>
                            ...
                            <div>
                                <section className="flex-box">
                                    <div id="pad">
                                        ...
                                        <p>Si has trabajado en la misma industria por muchos años, y estas buscando la forma de darle un giro a tu carrera,
                                            la programación puede ser la herramienta que te ayude a lograrlo; ya sea para crear tu propia empresa o convertirte en un
                            ...
                            <div>
                                <section className="flex-box">
                                    <div id="pad">
                                        ...
                                        <p>Si ya sabes programar pero quieres ampliar tus conocimientos o especializarte para obtener una mejor posición, o
                                            si tienes una empresa o puesto de managemente que requiere una línea de comunicación directa con desarrolladores,
                                            aprende lo necesario para lograrlo de manera efectiva.
                                        </p>
                                        <Link to="/bootcamp">
                            ...
                            <div>
                                <section className="flex-box">
                                    <div id="pad">
                                        ...
                                        <p>Al terminar la universidades, muchos profesionistan sienten que no tienes las habilidades necesarias para
                                            cubrir una posición e integrarse a un equipo de desarrollo, así que, si queires adquirir habilidades técnicas
                                            que te permitan iniciar tu carrera como desarrollador o product manager, inscríbete ya.
                                        </p>
                                        <Link to="/bootcamp">
                    ...
                    <div className="common inf" style={{alignItems:"center"}}>
                        <h2 className="subtitulo" >A world class curriculum
                        </h2>

                        <div className="flexbox">
                            <div className="containers">

                                <img src="https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt="laptop"/>
                            </div>
                            <div className="containers">
                                <p> Nuestro equipo de educación prepara un Curriculum adoc a cada herramienta y por cada modalidad, en donde cada uno de nuestros estudiantes
                                    pueda aprender las habilidades necesarias para convertirse en desarrollador, y así mejorar sus skills profesionales o conseguir un mejorar trabajo sin importar
