      ...
      <section className="bootcamp">
        ...
        <section className="container-bootcamp">
          <div className="container-summary">
            ...
            <p className="description">
              {" "}
              Aprende las bases de la programación, y prepárate para este
              programa, creado especialmente para principiantes que quieren
              incursionar en el mundo de Python: tanto para análisis de datos
              como para desarrollo web.{" "}
            </p>
            ...
            <div className="nivel">
              <p>
                Nivel <span style={{ fontSize: "10px" }}>(básico)</span>
              </p>
        ...
        <section className="contenedor download-t">
          <div className="temario">
            ...
            <p>
              <span>&bull;</span> Funciones, ciclos y condicionales
            </p>
            <p>
              <span>&bull;</span> Debug y logging
            </p>
            <p>
              <span>&bull;</span> Expresiones regulares en Python
            </p>
            <p>
              <span>&bull;</span> Funciones lambda
            </p>
            <p>
              <span>&bull;</span> Async IO
            </p>
            <p>
              <span>&bull;</span> Ambientes virtuales
            </p>
            <p>
              <span>&bull;</span> Scrapping
            </p>
            <p>
              <span>&bull;</span> SQL
            </p>
            <p>
              <span>&bull;</span> Pandas y más
            </p>
          </div>
          <div className="downl">
            <div>
              ...
              <br />
              <a
                href="https://firebasestorage.googleapis.com/v0/b/fixter-67253.appspot.com/o/assets%2FFundamentos_de_Programacio%CC%81n_Python.pdf?alt=media&token=cc9e4b75-1366-4a35-bf9a-79a221ed85d6"
                target="blank"
              >
