      ...
      <section className="bootcamp">
        ...
        <section className="container-bootcamp">
          <div className="container-summary">
            ...
            <p className="description">
              {" "}
              Aprende las bases de la programación y prepárate para incursionar
              en el mundo del desarrollo Web utilizando uno de los lenguajes más
              utilizados: JavaScript.
            </p>
        ...
        >
          <div className="box-programa">
            <h2>
              ¡Explora el poder del desarrollo web front-end con JavaScript!
            </h2>
            <br />
        ...
        <section className="contenedor download-t">
          <div className="temario">
            ...
            <p>
              <span>&bull;</span> Git y github
            </p>
            <p>
              <span>&bull;</span> HTML y CSS
            </p>
            <p>
              <span>&bull;</span> Selectotes y flexbox
            </p>
            <p>
              <span>&bull;</span> Manipulación del DOM
            </p>
            <p>
              <span>&bull;</span> Algoritmia
            </p>
            <p>
              <span>&bull;</span> Vanilla Js
            </p>
            <p>
              <span>&bull;</span> Webpack
            </p>
            <p>
              <span>&bull;</span> Hosting
            </p>
          </div>
          <div className="downl">
            <div>
              ...
              <br />
              <a
                href="https://firebasestorage.googleapis.com/v0/b/fixter-67253.appspot.com/o/assets%2FFundamentos_Desarrollo_Web.pdf?alt=media&token=80e68013-45be-429d-b9c8-5b58bc9a3615"
                target="blank"
              >
