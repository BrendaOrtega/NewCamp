      ...
      <section className="bootcamp">
        ...
        <section className="container-bootcamp">
          <div className="container-summary">
            ...
            <p className="description">
              {" "}
              En este curso presencial de 4 semanas aprenderás lo necesario para
              convertirte en un desarrollador frontend con uno de los frameworks
              más populares, utilizado por Facebook, Tesla y Twitter.
            </p>
        ...
        >
          <div className="box-programa">
            <h2>¡Explora el poder del desarrollo web front-end con ReactJs!</h2>
            <br />
            <h3>Por qué ReactJs...</h3>
            <p>
              ReactJs es uno de los frameworks más demandados y utilizados en el
              desarrollo web, utilizado en gran cantidad de aplicaciones como
              Tesla, Facebook, WhatsApp,
            </p>
            <br />
            <h3>Experiencia inigualable</h3>
            <p>
              En esta nueva modalidad de bootcamp online, te sumergirás en una
              experiencia única de aprendizaje, en donde concoerás las mejores
              prácticas del desarrollo para construir tu propio sitio web.
            </p>
          </div>
          <div className="box-data">
            <p>Próxima edición</p>
            <h3>18 de Marzo de 2020</h3>
        ...
        <section className="contenedor download-t">
          <div className="temario">
            ...
            <p>
              <span>&bull;</span> RecatJs
            </p>
            <p>
              <span>&bull;</span> Entornos de desarrollo
            </p>
            <p>
              <span>&bull;</span> Componentes
            </p>
            <p>
              <span>&bull;</span> Props y State
            </p>
            <p>
              <span>&bull;</span> Hooks
            </p>
            <p>
              <span>&bull;</span> Router
            </p>
            <p>
              <span>&bull;</span> Axios vs Fetch
            </p>
          </div>
          <div className="downl">
            <div>
