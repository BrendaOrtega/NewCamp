        ...
        <section className="bootcamp">
          ...
          <section className="camp-portada" style={{backgroundImage:`url("https://firebasestorage.googleapis.com/v0/b/fixter-67253.appspot.com/o/assets%2F20200427_204646.jpg?alt=media&token=534edde1-4cc5-400d-af2e-6f9ed4a1a3bd")`}}>
            <div className="camp-intro">
              ...
              <a href="https://firebasestorage.googleapis.com/v0/b/fixter-67253.appspot.com/o/assets%2FTemario_Bootcamp_Nodejs.pdf?alt=media&token=02eec427-cad2-49d3-9f21-35b775848140" target="_blank">
          ...
          <section className="sylabuss">
            ...
            <div className="instructor_box">
              <div className="instructor_photo">
                <img src="https://firebasestorage.googleapis.com/v0/b/fixter-67253.appspot.com/o/assets%2F18891870_1543998225611670_8032322982945740932_o.jpg?alt=media&token=85f36210-ffd5-4024-9763-bdca75e18b1b" alt="photo-oswaldo"/>
              </div>
              <div className="instructor_info">
                ...
                <div className="redes-instructor">
                  ...
                  <a href="https://www.linkedin.com/in/oswaldinho24k/" target="_blank">
                    <FontAwesome name="linkedin"/>
                  </a>
                  <a href="https://twitter.com/OswaldMarti" target="_blank">
     ...
     /* <section className="bootcamp">
        ...
        <section className="container-bootcamp">
          <div className="container-summary">
            <h2 className="name-descript">
              Backend API con NodeJs y ExpressJs
            </h2>
            <hr className="line-red" />
            <p className="description">
              En este curso te convertirás en un desarrollador backend y
              aprenderás a desarrollar una API con node js, es decir, estarás
              usando las mismas herramientas que aplicaciones como Netflix,
              LinkedIn Y PAYPAL para desarrollar una aplición poderosa
            </p>
            <Link to="/apply/?b=5de52ae9734c4163308b63fd">
            ...
            <div className="nivel">
              <p>
                Nivel <span style={{ fontSize: "10px" }}>(intermedio)</span>
              </p>
        ...
        >
          ...
          <div className="box-data">
            ...
            <hr />
            <p>
              Precio especial diciembre{" "}
              <span style={{ fontSize: "10px" }}>(hasta 6 MSI)</span>
            </p>
            <h3>$ 1,999.00</h3>
        ...
        <section className="contenedor download-t">
          <div className="temario">
            ...
            <p>
              <span>&bull;</span> Qué es un backend
            </p>
            <p>
              <span>&bull;</span> NodeJs
            </p>
            <p>
              <span>&bull;</span> Bases de datos SQL y NoSQL
            </p>
            <p>
              <span>&bull;</span> Diferencias entre un ODM y un ORM
            </p>
            <p>
              <span>&bull;</span> ExpressJs
            </p>
            <p>
              <span>&bull;</span> Autenticación de usuarios
            </p>
            <p>
              <span>&bull;</span> Mailing
            </p>
            <p>
              <span>&bull;</span> Deploy de API
            </p>
          </div>
          <div className="downl">
            <div>
              <h3>TEMARIO</h3>
              <p>
                ¿Quieres saber más sobre lo que aprenderás en el bootcamp?
                Descarga el temario completo en PDF
              </p>
              <br />
              <a
                href="https://firebasestorage.googleapis.com/v0/b/fixter-67253.appspot.com/o/assets%2FBackend.pdf?alt=media&token=c6a10d3a-eb01-4938-adbe-28d8ce47b7b7"
                target="blank"
              >
